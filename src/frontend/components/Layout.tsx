          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <button
                ...
                className={`relative p-2.5 rounded-full transition-colors ${isNotificationsOpen ? 'bg-gray-100 text-gray-600' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-600'}`}
              >
                <Bell size={22} />
              ...
              {/* Notification Dropdown Overlay (to close on click outside) */}
              {isNotificationsOpen && (
              ...
              {/* Dropdown Menu */}
              {isNotificationsOpen && (
                <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
