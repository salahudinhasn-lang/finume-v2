...
export const CareersPage = () => {
    const { t } = useAppContext();
    return (
        <PageContent title={t('pol.careersTitle')} icon={UserCheck}>
            <div className="text-center mb-12">
                <p className="text-xl text-gray-600">{t('pol.careersSubtitle')}</p>
            </div>
            <div className="space-y-4 max-w-3xl mx-auto">
                {[
                    ...
                    <div key={i} className="flex items-center justify-between p-6 bg-white border border-gray-200 rounded-xl hover:border-primary-500 transition-colors cursor-pointer group">
                        ...
                        <Button variant="outline" size="sm">{t('pol.applyNow')}</Button>
                    </div>
                ))}
            </div>
        </PageContent>
...
export const PrivacyPage = () => {
    const { t } = useAppContext();
    return (
        <PageContent title={t('pol.privacyTitle')} icon={Shield}>
            <div className="prose prose-blue text-gray-600 max-w-3xl mx-auto">
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.privacy1Title')}</h3>
                <p className="mb-6">{t('pol.privacy1Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.privacy2Title')}</h3>
                <p className="mb-6">{t('pol.privacy2Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.privacy3Title')}</h3>
                <p className="mb-6">{t('pol.privacy3Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.privacy4Title')}</h3>
                <p className="mb-6">{t('pol.privacy4Desc')}</p>
            </div>
        </PageContent>
    );
};
...
export const TermsPage = () => {
    const { t } = useAppContext();
    return (
        <PageContent title={t('pol.termsTitle')} icon={FileText}>
            <div className="prose prose-blue text-gray-600 max-w-3xl mx-auto">
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.terms1Title')}</h3>
                <p className="mb-6">{t('pol.terms1Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.terms2Title')}</h3>
                <p className="mb-6">{t('pol.terms2Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.terms3Title')}</h3>
                <p className="mb-6">{t('pol.terms3Desc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.terms4Title')}</h3>
                <p className="mb-6">{t('pol.terms4Desc')}</p>
            </div>
        </PageContent>
    );
};
...
export const CompliancePage = () => {
    const { t } = useAppContext();
    return (
        <PageContent title={t('pol.complianceTitle')} icon={ShieldCheck}>
            <div className="prose prose-blue text-gray-600 max-w-3xl mx-auto">
                <div className="bg-green-50 border border-green-200 p-6 rounded-xl mb-8">
                    <h3 className="text-lg font-bold text-green-800 mb-2 flex items-center gap-2"><CheckCircle size={20} /> {t('pol.compPhase2')}</h3>
                    <p className="text-green-700">{t('pol.compPhase2Desc')}</p>
                </div>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.compCommit')}</h3>
                <p className="mb-6">{t('pol.compCommitDesc')}</p>

                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('pol.compServices')}</h3>
