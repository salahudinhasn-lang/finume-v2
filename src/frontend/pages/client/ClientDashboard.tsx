...
const ClientDashboard = () => {
    ...
    React.useEffect(() => {
        ...
        if (action === 'subscribe_plan') {
            ...
            if (plan) {
                ...
                const billedRate = isYearly ? Math.round(monthlyBase * 0.8) : monthlyBase;
                const totalAmount = isYearly ? billedRate * 12 : billedRate;
    ...
    }, [user, location, plans, addRequest, navigate]);
