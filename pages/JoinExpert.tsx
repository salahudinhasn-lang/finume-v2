...
const JoinExpert = () => {
    const { addExpert, login, t, language } = useAppContext();
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            ...
            <div className="lg:w-5/12 bg-[#0B0F19] text-white p-8 lg:p-16 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="space-y-8">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-xl mb-1">{t('joinExpert.highValue')}</h3>
                                <p className="text-gray-400 text-sm">{t('joinExpert.highValueDesc')}</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="p-3 bg-white/5 rounded-xl border border-white/10 h-fit">
                            ...
                            <div>
                                <h3 className="font-bold text-xl mb-1">{t('joinExpert.careerGrowth')}</h3>
                                <p className="text-gray-400 text-sm">{t('joinExpert.careerGrowthDesc')}</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="p-3 bg-white/5 rounded-xl border border-white/10 h-fit">
                            ...
                            <div>
                                <h3 className="font-bold text-xl mb-1">{t('joinExpert.exclusiveCommunity')}</h3>
                                <p className="text-gray-400 text-sm">{t('joinExpert.exclusiveCommunityDesc')}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 mt-12 pt-12 border-t border-white/10">
                    <div className="flex items-center gap-4">
                        ...
                        <p className="text-sm text-gray-400" dangerouslySetInnerHTML={{ __html: t('joinExpert.joinCount') }}></p>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:w-7/12 flex flex-col justify-center p-4 lg:p-16">
                <div className="max-w-2xl mx-auto w-full">
                    <div className="mb-8 flex justify-between items-end">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">{t('joinExpert.formTitle')}</h2>
                            <p className="text-gray-500">{t('joinExpert.formDesc')}</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('auth.fullName')}</label>
                                ...
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.phone')}</label>
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.linkedinUrl')}</label>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.yearsEx')}</label>
                                ...
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.hourlyRate')}</label>
                                    <div className="relative">
                                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-xs">{t('common.sar')}</span>
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.specializations')}</label>
                                    <div className="flex gap-2 mb-2">
                                        ...
                                        />
                                        <Button type="button" onClick={handleAddSpecialization} variant="secondary" className="rounded-xl">{t('joinExpert.add')}</Button>
                                    </div>
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-xs font-semibold text-gray-700 mb-1">{t('joinExpert.bio')}</label>
                                    <textarea required name="bio" value={formData.bio} onChange={handleChange} rows={3} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all" placeholder={t('joinExpert.bioPlaceholder')} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer group">
                                ...
                                <p className="font-bold text-gray-700 text-sm">{t('joinExpert.uploadCv')}</p>
                                <p className="text-xs text-gray-400 mt-1">{t('joinExpert.fileType')}</p>
                            </div>
                        </div>

                        <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
                            <p className="text-xs text-gray-500 max-w-xs">{t('joinExpert.submitAgreement')}</p>
                            <Button type="submit" size="lg" className="bg-primary-600 hover:bg-primary-700 shadow-lg px-8 rounded-xl">
                                {t('joinExpert.submit')} <ArrowRight size={18} className="ml-2" />
                            </Button>
                        </div>
