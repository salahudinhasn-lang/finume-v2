                ...
                <tr key={req.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2">
                        <Button size="sm" variant="secondary" onClick={() => setSelectedRequest(req)} className="h-8 w-8 p-0"><Eye size={16} /></Button>
                          ...
                          {['NEW', 'MATCHED', 'IN_PROGRESS', 'REVIEW_CLIENT', 'COMPLETED'].map((step, idx) => {
                              ...
                              return (
                                  <div key={step} className="flex items-start gap-4 mb-6 relative z-10 last:mb-0">
                                      <div className={`w-12 h-12 rounded-full flex items-center justify-center border-4 transition-colors shrink-0 ${
