...
const SimplePage = ({ title, icon: Icon, children }: { title: string, icon: any, children: React.ReactNode }) => (
    <div className="bg-white min-h-screen">
        <PageHeader title={title} icon={Icon} color="slate" />
        <Section>
...
export const QAPage = () => {
    const { t } = useAppContext();
    return (
        <SimplePage title={t('public.faqTitle')} icon={FileQuestion}>
...
export const PrivacyPage = () => {
    const { t } = useAppContext();
    return (
        <SimplePage title={t('pol.privacyTitle')} icon={Shield}>
...
export const CareersPage = () => {
    ...
    return (
        <div className="bg-white">
            <PageHeader title={t('pol.careersTitle')} icon={UserCheck} color="pink" />
            <Section>
...
export const TermsPage = () => {
    const { t } = useAppContext();
    return (
        <SimplePage title={t('pol.termsTitle')} icon={FileText}>
...
export const CompliancePage = () => {
    const { t } = useAppContext();
    return (
        <SimplePage title={t('pol.complianceTitle')} icon={ShieldCheck}>
