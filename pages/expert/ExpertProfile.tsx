                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="flex items-center gap-6 pb-6 border-b border-gray-100">
                     <div className="relative">
                        <img src={user?.avatarUrl} alt="Profile" className="w-24 h-24 rounded-full bg-gray-200 object-cover ring-4 ring-gray-50" />
                        <button type="button" className="absolute bottom-0 right-0 p-1.5 bg-white rounded-full shadow-md border border-gray-200 text-gray-500 hover:text-primary-600">
                            <Upload size={14} />
                        </button>
                     </div>
                     <div>
          ...
          <div className="space-y-6">
              ...
              <Card>
                  ...
                  <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-4 text-white text-center">
                      <img src={user?.avatarUrl} className="w-16 h-16 rounded-full mx-auto border-2 border-white mb-2" />
